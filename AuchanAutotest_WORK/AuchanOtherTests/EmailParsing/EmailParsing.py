    ...
    def get_first_text_block(self, email_message_instance):
        ...
        if maintype == 'multipart':
            ...
            for i in cost_span_list:
               #a = re.findall('^[0-9]*[.,]?[0-9]+$', i) #целые и дробные числа с точкой и запятой
               a = re.findall('[0-9]+[.,][0-9]{2}', i) #!только дробные числа с точкой и запятой (целые игнорирует) и двумя цифрами после точки или запятой
